...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<?= base_url('AdminLTE320') ?>/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="<?= base_url()?>" class="h1"><b>GIS </b>Desa</a>
    </div>
    <div class="card-body">
