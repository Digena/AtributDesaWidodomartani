...
<?php echo form_open_multipart('Atribut/UpdateData/' . $atribut['id_atribut']) ?>

<div class="row">
        <div class="col-sm-6">
          <div class="form-group">
            <label>Nama Pemilik</label>
            <input name="nama_pemilik" value="<?= $atribut['nama_pemilik'] ?>" placeholder="Nama Pemilik" class="form-control">
...
<div class="col-sm-3">
          <div class="form-group">
            ...
            <input name="jumlah_keluarga" value="<?= $atribut['jumlah_keluarga'] ?>"  placeholder="jumlah_keluarga" class="form-control">
...
<div class="col-sm-3">
          <div class="form-group">
            <label>Luas (m2)</label>
            <input name="luas" value="<?= $atribut['luas'] ?>" placeholder="luas" class="form-control">
...
<div class="col-sm-4">
          <div class="form-group">
            ...
            <input name="anggaran" value="<?= $atribut['anggaran'] ?>" placeholder="anggaran" class="form-control">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <option value="<?= $atribut['jenis_atribut'] ?>"><?= $atribut['jenis_atribut'] ?></option>
          ...
          <div class="form-group">
            ...
            <select name="id_kondisi" class="form-control">
              ...
              <?php foreach ($kondisi as $key => $value) { ?>
                <option value="<?= $value['id_kondisi'] ?>" <?= $value['id_kondisi'] == $atribut['id_kondisi'] ? 'selected' : '' ?>><?= $value['kondisi'] ?></option>
              <?php } ?>
            </select>
            <p class="text-danger"><?= $validation->hasError('id_kondisi') ? $validation->getError('id_kondisi') : '' ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <input name="koordinat" id=" koordinat " value="<?= $atribut['koordinat'] ?>" placeholder="Koordinat Atribut" class="form-control" readonly>
      ...
      <div class="col-xl-4">
          <div class="form-group">
            ...
            <option value="">--Pilih Provinsi---</option>
              <?php foreach ($provinsi as $key => $value) { ?>  
                <option value="<?= $value['id_provinsi'] ?>" <?= $value['id_provinsi'] == $atribut['id_provinsi'] ? 'selected' : '' ?>><?= $value['nama_provinsi'] ?></option>
              <?php  } ?>
              </select>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <option value="<?= $atribut['id_kabupaten'] ?>"><?= $atribut['nama_kabupaten'] ?></option>    
        </select>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <option value="<?= $atribut['id_kecamatan'] ?>"><?= $atribut['nama_kecamatan'] ?></option>    
        </select>
      ...
      <div class="row">
        <div class="col-sm-8">
          <div class="form-group">
            <label>Alamat</label>
            <input name="alamat" value="<?= $atribut['alamat'] ?>" placeholder="Alamat Atribut" class="form-control">
          ...
          <div class="form-group">
            ...
            <option value="">--Pilih Wilayah Administrasi---</option>
              <?php foreach ($wilayah as $key => $value) { ?>
                <option value="<?= $value['id_wilayah'] ?>" <?= $value['id_wilayah'] == $atribut['id_wilayah'] ? 'selected' : '' ?>><?= $value['nama_wilayah'] ?></option>
              <?php  } ?>  
          </select>
      ...
      <div class="col-sm-4">
      <div class="form-group">
        <label>Ganti Foto Atribut</label>
